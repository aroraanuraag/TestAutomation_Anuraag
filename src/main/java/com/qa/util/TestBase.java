...
public class TestBase {
	...
	public TestBase()   // This is the Constructor - Constructor name is same as Class name.
	{
		...
		try {
			...
			prop = new Properties();
			FileInputStream ip = new FileInputStream("C:\\TEST Automation - Selenium Java\\eclipse-workspace\\Om_Sai_Ram_PDF_REPORT _and_OtherRnd\\src\\main\\java\\com\\qa\\config\\config.properties");
			prop.load(ip);
	...
	public static void initialization()
	{
		...
		{
			System.setProperty("webdriver.chrome.driver",System.getProperty("user.dir")+"\\BrowserFiles\\chromedriver.exe");
